...
export const Button: React.FC<ButtonProps> = ({
  ...
  const variants = {
    default: "px-6 py-3 flex items-center justify-center",
    twitch: "rounded-lg px-4 py-3",
    skew: "",
  }
  ...
  return (
    <button
      className={clsx(
        "relative font-bold text-black text-sm bg-white flex items-center gap-x-2 cursor-pointer",
    ...
    >
      ...
      <span
        className={clsx(
          "",
          variant === "skew"
            ? "bg-[#F0E74D] block px-6 py-3 whitespace-nowrap"
            : null,
          skewColor
        )}
        style={{
